# Generated by Django 5.1.1 on 2024-11-14 22:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('selling_price', djmoney.models.fields.MoneyField(decimal_places=0, default_currency='USD', max_digits=14)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='entries', to='shop.product')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('email', models.EmailField(default='', max_length=255, validators=[django.core.validators.EmailValidator(message='Enter a valid email address.')])),
                ('address', models.TextField(default='')),
                ('order_date', models.DateTimeField(auto_now_add=True)),
                ('is_deleted', models.BooleanField(default=False)),
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('state_or_region', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='cities_light.region')),
                ...
                ('product_entry', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='shop.productentry')),
                ('status', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='orders', to='shop.status')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_actions', to='shop.status')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='status_actions', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
